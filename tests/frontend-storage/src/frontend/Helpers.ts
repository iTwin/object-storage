...
export function arrayBufferToReadableStream(buffer: ArrayBuffer): ReadableStream {
...
export function assertArrayBuffer(
  ...
  expect(arrayBufferEquals(got as ArrayBuffer, expected), "got != expected").to.be.true;
}
...
export async function assertReadableStream(
  ...
  expect(arrayBufferEquals(gotBuffer, expectedAsBuffer), "got != expected").to.be.true;
}
